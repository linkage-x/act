...
SIM_TASK_CONFIGS = {
    ...
    "monte01_peg_in_hole": {
        ...
        "camera_names": [
            ...
            "right_ee_cam",
            "third_person_cam",
        ],  # Mapped from left->ee_cam, right->right_ee_cam
    ...
    "fr3_mixed_training_bs": {
        ...
        "camera_names": [
            ...
            "third_person_cam",
            "side_cam",
        ],  # Common cameras across datasets
        "state_dim": 8,  # FR3: 7 DOF arm + 1 DOF gripper
    },
    # Preprocessed block stacking dataset (optimized episode lengths)
    "fr3_bs_mix_ds_0924": {
        "dataset_dir": [
            "/boot/common_data/fr3_bs_0916_50ep_ds_hdf5",
    ...
    "fr3_pih_0918_48ep_ds": {
        "dataset_dir": [
            "/boot/common_data/fr3_pih_0918_48ep_ds_hdf5",
        ],
...
MONTE01_GRIPPER_UNNORMALIZE_FN = lambda x: np.clip(
    x * MONTE01_GRIPPER_OPEN, 0, MONTE01_GRIPPER_OPEN
)
